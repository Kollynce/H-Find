...
@section('content')
    @include('inc.banner1')
    <div id="property listing1" class="container padding bg_gallery listing1 padding_top">
        <div class="row">
            ...
            @foreach($search as $get)
                <div class="-columns col-md-4">
                    <div class="property_item heading_space">
                        <div class="image">
                            <a href="{{route('property.show', $get->id)}}"><img style="width: 400px;height: 200px;" src="/image/{{ $get->property1 }}" class="img-responsive"></a>
